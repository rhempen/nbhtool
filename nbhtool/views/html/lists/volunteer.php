<h1><span class="db-id">Liste: </span>Freiwillige</h1>
<?php include('_listsvolunteernav.php') ?>
...
<?php \Layout\Html\Tools::widget('table', [
    ...
    'columns' => [
        'Id' => [
            'field' => 'id',
            'template' => '<a
            href="'.\Layout\Html\Tools::url('person/volunteer',['person_id' =>
            '{person_id}']).'"><strong>#{person_id}</strong></span><a>'
        ],
        'Status' => ['field' => 'state'],
        'Anrede' => ['field' => 'gender'],
        'Titel' => ['field' => 'title'],
